const {
  ...
  //const DECIMALS = 1;
  const makerAssetData = assetDataUtils.encodeERC721AssetData(tokenAAddress,BigNumber(0));
  const takerAssetData = assetDataUtils.encodeERC721AssetData(tokenBAddress,BigNumber(0));  
  const makerAssetAmount = BigNumber(1);
